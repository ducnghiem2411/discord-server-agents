...
Tập hợp thông tin _đang hoạt động_ tại một thời điểm — những gì agent "đang nhớ" trong cuộc hội thoại hiện tại.

- Kỹ thuật: Window · Compression · Retrieval-augmented

### Self-improve

Cơ chế agent điều chỉnh hành vi dựa trên kết quả và feedback — không cần retrain model.

- Cơ chế: Reflection · RAG update · Prompt tuning
